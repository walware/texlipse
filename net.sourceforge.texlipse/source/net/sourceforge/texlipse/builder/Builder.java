/*
 * $Id: Builder.java,v 1.1 2005/03/16 12:21:56 kimmok Exp $
 *
...
public interface Builder {
	 ...
	 * @throws CoreException if the build fails
	 */
	public void build(TexPathConfig pathConfig) throws CoreException;
	
	/**
	 * Starts the execution of the program runner sequence, but not the progress monitor listener.
	 * @param pathConfig the project main file
	 */
